...
import com.yusril.skripsi_app.databinding.ActivityMultiplikatifFuturePredictionBinding
import com.yusril.skripsi_app.ui.forecastFuture.viewmodel.ForecastFutureModel

class MultiplikatifFuturePredictionActivity : AppCompatActivity() {
    private lateinit var forecastFutureModel: ForecastFutureModel
    private lateinit var binding: ActivityMultiplikatifFuturePredictionBinding
    private lateinit var swipeContainer: SwipeRefreshLayout
    private lateinit var dataFutureListAdapter: DataFutureListAdapter
    private var touristDataType:String = ""
    private var idMethod:Int = 2
    private var idTouristDataType:Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_multiplikatif_future_prediction)
        binding = ActivityMultiplikatifFuturePredictionBinding.inflate(layoutInflater)
